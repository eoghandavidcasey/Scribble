...
class HomePagesControllerTest < ActionController::TestCase
  ...
  test "should create home_page" do
    assert_difference('HomePage.count') do
      post :create, home_page: { post_id: @home_page.post_id, title: @home_page.title, user_id: @home_page.user_id }
    end
  ...
  test "should update home_page" do
    patch :update, id: @home_page, home_page: { post_id: @home_page.post_id, title: @home_page.title, user_id: @home_page.user_id }
    assert_redirected_to home_page_path(assigns(:home_page))
  end
